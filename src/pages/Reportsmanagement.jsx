...
const Reportsmanagement = () => {
  ...
  // API Endpoints
  const apiEndpoints = {
      users: `${backend}/api/auth/admin/generateUserReportsby-admin`,
      orders: `${backend}/api/auth/admin/generateOrderStatusReportsby-admin`,
      restaurants: `${backend}/api/auth/admin/generateRestaurantReportBy-admin`,
      drivers: `${backend}/api/auth/admin/getDeliveryBoyReportsby-admin`,
  };
